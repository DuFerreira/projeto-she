...
'Back': 'Back',
'Bem vindo ao Sistema de Ensino Hibrido': 'Bem vindo ao Sistema de Ensino Hibrido',
'Bem vindo!': 'Bem vindo!',
...
'Enter date as %(format)s': 'Insira data como %(format)s',
...
'Helping web2py': 'Ajudante web2py',
'Home': 'Principal',
...
'Insufficient privileges': 'Permissão insuficiente',
...
'Sistema Hibrido de Ensino': 'Sistema Hibrido de Ensino',
